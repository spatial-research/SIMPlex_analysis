...
Total uncompressed: ~37 GB. The repository's `.gitignore` excludes everything here except this `README.md`, so the folder appears in git but no heavy file is ever tracked.
