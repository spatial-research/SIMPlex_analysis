...
This deposit has already been copied into `data/r_objects/` (37 GB). If you need to re-populate from a fresh download, unpack the KTH archive over `data/r_objects/` (see README §4).
...
- Location: `data/external_references/BC_atlas/miniatlas.rds`
...
- Location: `data/external_references/CAF_Cords2023/BREAST_fibro_tumour.rds`
...
- Location: `data/external_references/snPATHO/4066_snPatho.rds`
...
- Location: `data/external_references/mouse_brain_atlas/l5_all.loom`
...
- Location: `data/external_references/mouse_brain_atlas/allen_cortex.rds`
...
- Location: `data/external_references/mouse_forebrain_10x/10k_mouse_forebrain_scFFPE_singleplex_count_sample_filtered_feature_bc_matrix.h5`
...
- Location: `data/external_references/10x_BC_FFPE/320k_scFFPE_16-plex_GEM-X_FLEX_BreastCancer1_BC7-8_count_sample_filtered_feature_bc_matrix.h5`
- Used by: `analysis_majorLevel.rmd` (FFPE QC comparator)

### PCa scRNA-seq atlas (Erickson lab, Oct 2023) ✅
- Location: `data/external_references/PCa_atlas/PCa_atlas_annotated_Oct23_update.rds`
