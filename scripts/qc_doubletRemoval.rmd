...
for (sample in samples){
  ...
  saveRDS(object, paste0(paste0(DATA_ROOT, "/r_objects/breast_cancer/single_nuclei/per_sample/"), patient, "/", sample, ".rds"))
}
```

## Merge samples 
```{r}
samplePath <- paste0(DATA_ROOT, "/r_objects/breast_cancer/single_nuclei/per_sample/")
spls <- list()
...
# Save n load
```{r}
saveRDS(spl.filt, paste0(paste0(DATA_ROOT, "/r_objects/breast_cancer/single_nuclei/per_sample/"), patient, "/", patient, "_merged.rds"))
```
```{r}
spl.filt <- readRDS(paste0(paste0(DATA_ROOT, "/r_objects/breast_cancer/single_nuclei/per_sample/"), patient, "/", patient, "_merged.rds"))
```
...
```{r}
saveRDS(data_list, paste0(paste0(DATA_ROOT, "/r_objects/breast_cancer/single_nuclei/per_sample/"), patient, "/", patient, "_merged_postDoublet.rds"))
```
...
## Save object
```{r save_RDS}
saveRDS(spl.filt_noDoublets, file = paste0(paste0(DATA_ROOT, "/r_objects/breast_cancer/single_nuclei/per_sample/"), patient, "/", patient, "_noDoublets.rds"))
```
