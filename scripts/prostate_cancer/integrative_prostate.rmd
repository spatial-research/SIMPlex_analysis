...
### Settings 
```{r}
rootObj <- paste0(DATA_ROOT, "/r_objects/prostate_cancer/integrated/cafs/")
...
spl_paths <- list(
    "pt10" = list(
        path = paste0(DATA_ROOT, "/r_objects/prostate_cancer/single_nuclei/pt10_HD_seuratAnnotation.rds"),
        subtype = "NA"
    ),
    "pt20" = list(
        path = paste0(DATA_ROOT, "/r_objects/prostate_cancer/single_nuclei/pt20_HD_seuratAnnotation.rds"),
        subtype = "NA"
    )
)
spls <- list()
...
saveRDS(se.hd, paste0(paste0(DATA_ROOT, "/r_objects/prostate_cancer/HD/", sample, "_visHD.rds"))
}
```
...
spls <- list()
for (sample in samples){
    vis <- readRDS(paste0(paste0(DATA_ROOT, "/r_objects/prostate_cancer/HD/", sample, "_visHD.rds"))
...
saveRDS(int.all, paste0(paste0(DATA_ROOT, "/r_objects/prostate_cancer/integrated/"), "integrated_all.rds"))
```
...
### Settings 
```{r}
rootObj <- paste0(DATA_ROOT, "/r_objects/prostate_cancer/integrated/epithelial/")
...
saveRDS(int.all, paste0(paste0(DATA_ROOT, "/r_objects/prostate_cancer/integrated/"), "integrated_all_epithelial.rds"))
```
...
int.all <- readRDS(paste0(paste0(DATA_ROOT, "/r_objects/prostate_cancer/integrated/"), "integrated_all_epithelial.rds"))
```
...
```{r}
obj <- readRDS(paste0(DATA_ROOT, "/r_objects/prostate_cancer/integrated/integrated_all_epithelial.rds"))
wd <- paste0(FIGS_ROOT, "/prostate_cancer/epithelial/")
```
```{r}
