...
write.csv(sn.markers.subclass, paste0(DATA_ROOT, "/r_objects/mouse_brain/top5_markers_subclass.csv"), row.names = FALSE)
...
write.csv(sn.markers.tax4, paste0(DATA_ROOT, "/r_objects/mouse_brain/top5_markers_tax4.csv"), row.names = FALSE)
...
write.csv(sn.markers.allen, paste0(DATA_ROOT, "/r_objects/mouse_brain/top5_markers_allen.csv"), row.names = FALSE)
...
```{r save}
saveRDS(snMB.filt_singlet, file = paste0(DATA_ROOT, "/r_objects/mouse_brain/snRNA.rds"))
```
