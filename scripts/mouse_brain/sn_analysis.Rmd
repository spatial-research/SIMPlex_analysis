...
snMB_cellbender.data <- Read_CellBender_h5_Mat(file_name = paste0(DATA_ROOT, "/cellbender/mouse_brain/mb_cellbender_output_filtered.h5"), use.names = TRUE)
...
```{r load_ref_data}
mb_sc_ref.loom <- Connect(filename = paste0(DATA_ROOT, "/external_references/mouse_brain_atlas/l5_all.loom"), mode = "r")
...
se.allen <- readRDS(paste0(DATA_ROOT, "/external_references/mouse_brain_atlas/allen_cortex.rds"))
...
write.csv(sn.markers.subclass, paste0(DATA_ROOT, "/processed_data/mouse_brain/top5_markers_subclass.csv"), row.names = FALSE)
...
write.csv(sn.markers.tax4, paste0(DATA_ROOT, "/processed_data/mouse_brain/top5_markers_tax4.csv"), row.names = FALSE)
...
write.csv(sn.markers.allen, paste0(DATA_ROOT, "/processed_data/mouse_brain/top5_markers_allen.csv"), row.names = FALSE)
...
```{r save}
saveRDS(snMB.filt_singlet, file = paste0(DATA_ROOT, "/processed_data/mouse_brain/snRNA.rds"))
```
